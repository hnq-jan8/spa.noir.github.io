            ...
            <div className="flex items-center gap-2 -ml-1">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center p-1 text-gray-900 hover:text-amber-700 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`w-auto ${"size" in social ? social.size : "h-4"} ${"nudgeY" in social ? social.nudgeY : ""}`}
